        ...
        <div class="row">
          <div class="col-12 col-md-6">
            ...
            <div class="form-group">
              ...
              option-value="id" />
              <q-btn color="red-14" label="REVIEWED" icon="fact_check" @click="decision()" class="q-mr-sm q-mt-sm" :disable="!decision_status" />
              
              <q-btn color="red-14" label="RETURN TO SCREENER" icon="assignment_return" @click="reassign(1005)" class="q-mr-sm q-mt-sm" />
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      async reassign(user_role){
        ...
        if(user_role == 1005){
          payload.data.assigned_user_id = vm.screener_id.id;
        }
